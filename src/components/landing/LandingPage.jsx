...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      style={{
        boxShadow: scrolled ? "0 4px 24px rgba(0,0,0,0.10)" : "0 1px 0 #E8E8E8",
      }}
    >
      <div
        className="max-w-[1280px] mx-auto px-6 md:px-8 flex items-center justify-between"
        style={{ height: 72 }}
      >
        {/* Logo */}
      ...
      {/* Mobile drawer */}
      <div
        className={`mobile-nav-drawer md:hidden bg-white border-t border-[#E8E8E8] ${menuOpen ? "open" : ""}`}
      >
...
const HERO_PHOTOS = [
  {
    src: "/assets/images/landing/hero-1.png",
    alt: "Singer",
    fallback: "#1a0e05",
  },
  {
    src: "/assets/images/landing/hero-2.png",
    alt: "Dancer",
    fallback: "#0e0e14",
  },
  {
    src: "/assets/images/landing/hero-3.png",
    alt: "Guitarist",
    fallback: "#1a1200",
  },
  {
    src: "/assets/images/landing/hero-4.png",
    alt: "Carnival dancer",
    fallback: "#1a0505",
  },
  {
    src: "/assets/images/landing/hero-5.png",
    alt: "Musician",
    fallback: "#0a0a14",
  },
];
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      if (leftRingRef.current)
        leftRingRef.current.style.transform = `translateY(calc(-60% + ${y}px))`;
      if (rightRingRef.current)
        rightRingRef.current.style.transform = `translateY(calc(-60% + ${y}px))`;
    };
    window.addEventListener("scroll", onScroll, { passive: true });
    return () => window.removeEventListener("scroll", onScroll);
  }, []);
  ...
  return (
    ...
    >
      ...
      <Reveal className="relative z-10 flex flex-col items-center text-center px-6 pt-12 md:pt-16 pb-10">
        ...
        >
          Build your personalized portfolio and find your next best opportunity
          with Interflow
        </p>
        <button
          onClick={() => navigate("/register")}
    ...
    >
      ...
      <div
        ...
        style={{
          width: 640,
          height: 640,
          background: "linear-gradient(to right, #8D5D1D, #271A08)",
          zIndex: 0,
        }}
      />
      ...
      <div
        ...
        style={{ background: "#E8DDD0", zIndex: 1 }}
      >
        <div
        ...
        >
          ...
          <Reveal delay={150} className="flex-1">
            ...
            <p className="text-[#333] text-[15px] leading-relaxed mb-4">
              Interflow is an Artist's exchange platform where creativity meets
              opportunity
            </p>
            <p className="text-[#444] text-[15px] leading-relaxed mb-9">
              Artists can build dynamic portfolios, showcase their talent, grow
              their skills and connect with organizations ………
            </p>
            <button
              onClick={() => navigate("/register")}
  ...
  >
    ...
    >
      <div
        ...
        style={{ height: 236, background: "#1a1a1a" }}
      >
        <img
          src={img}
          alt={title}
      ...
      <div
        ...
        style={{ padding: "22px 26px 24px", height: 224 }}
      >
        <h3
        ...
        <p className="text-[#555] leading-relaxed" style={{ fontSize: 14 }}>
          {desc}
        </p>
      </div>
    </div>
  ...
  >
    ...
    <Reveal className="relative z-10 text-center mb-14 px-6">
      ...
      <p className="text-[#888] text-[15px] mt-4 max-w-[500px] mx-auto leading-relaxed">
        Interflow helps you showcase your achievements in your own way, discover
        and apply for global opportunities and share your portfolio
      </p>
    </Reveal>
...
const STATS = [
  {
    num: "$2T",
    sup: "+",
    label: "$2T+ Creative Economy",
    sub: "Fuelling innovation and culture worldwide (UNCTAD, 2022)",
  },
  {
    num: "20%",
    sup: null,
    label: "20% of Creative Employers.",
    sub: "Prefer candidates with dynamic online portfolios (AIGA/Behance 2022)",
  },
  {
    num: "$13B",
    sup: "+",
    label: "$13B+ Untapped Revenue",
    sub: "Untapped revenue potential in the Nigeria arts sector.",
  },
  {
    num: "48%",
    sup: null,
    label: "48% Loose Opportunity",
    sub: "Loose opportunity due to lack of digital visibility (Arts council, 2021)",
  },
];
  ...
  >
    ...
    >
      <div
        ...
        style={{ width: 156, height: 156, background: "#E8DDD0" }}
      />
      <p
    ...
    <p className="text-[#666] leading-relaxed" style={{ fontSize: 14 }}>
      {sub}
    </p>
  </div>
);
...
const Stats = () => (
  <section
    ...
    style={{ background: "#E8DDD0", padding: "80px 0 96px" }}
  >
    <div className="max-w-[1160px] mx-auto px-6 md:px-10">
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-12 items-center">
        ...
        <Reveal
          delay={100}
          className="relative shrink-0 self-center w-full md:w-auto"
          style={{ maxWidth: 400, paddingTop: 18, paddingLeft: 18 }}
        >
          <div
...
const FooterHeading = ({ children }) => (
  <div className="mb-6">
    ...
    <div
      style={{ width: 52, height: 2.5, background: GOLD, borderRadius: 2 }}
    />
  </div>
);
  ...
  >
    ...
    <span
      ...
      style={{
        width: 32,
        height: 32,
        background: outline ? "#FFFFFF" : "#0A0A0A",
        flexShrink: 0,
      }}
    >
      ...
      >
        ...
        <Reveal className="w-full md:max-w-[360px]">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <FooterBtn onClick={() => navigate("/register")}>
              Sign up today
            </FooterBtn>
            <FooterBtn onClick={() => navigate("/login")} outline>
              Sign In
            </FooterBtn>
          </div>
        </Reveal>
        ...
        <Reveal delay={100}>
          ...
          <ul className="flex flex-col" style={{ gap: 18 }}>
            {["About Interflow", "Artists", "Organizations", "Resources"].map(
              (link) => (
                <li key={link}>
                  <a
                    href="#"
