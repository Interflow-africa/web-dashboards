...
export const orgAPI = {
  ...
  uploadLogo: (data) => api.patch('/organization/me/', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
...
export const opportunitiesAPI = {
  ...
  manageDetail: (pk) => api.get(`/opportunities/manage/${pk}/`),
  create: (data, publish = false) => api.post(`/opportunities/manage/${publish ? '?publish=true' : ''}`, data),
